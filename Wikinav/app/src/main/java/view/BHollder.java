...
public class BHollder extends RecyclerView.Adapter<BHollder.ViewHolder> {
    ...
    public BHollder(ArrayList<String> allLinks, OnlinkListener onlinkListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.article_b_line, parent, false);

        return new BHollder.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tv_allTitleB.setText(str);



        holder.root_B .setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_allTitleB;
        public View root_B ;
        public ViewHolder(View itemView) {
            super(itemView);
            tv_allTitleB = (TextView) itemView.findViewById(R.id.tv_allTitleB);
            root_B  = itemView.findViewById(R.id.root_B);
        }
    }

    //Notre moyen de communication
    public interface OnlinkListener {
        void onClick(String articleB);
    }
